...
class Realizar_Pedido(Screen):
    def __init__(self, **kwargs):
        ...
        # Espacio para el botón de aceptar
    ...
    # Funcion que permite ver la mesa que fue seleccionad y actualizar su valor
    ...
    def aceptar_pedido(self, instance):
        if self.mesa_seleccionada is not None:
            ...
            # Se manda la informacion a la base de datos y luego se cambia a la pantalla de estatus
    ...
    # Método para mostrar los valores de custom_selected en consola
